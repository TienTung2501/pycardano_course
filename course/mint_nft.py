...
# Đơn giản hóa: Chỉ tạo 1 NFT với thuộc tính ngẫu nhiên
asset = {
...
print(f"NFT minted: {asset_name} (Type: {asset['type']}, Attack: {asset['attack']}, Speed: {asset['speed']}, Defense: {asset['defense']}, Health: {asset['health']})")